...
const Footer = () => {
    return (
        <div className='bottom-0 inset-x-0 relative'>
            <footer className="footer p-10 bg-indigo-400 text-white">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-indigo-400 text-white border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Quizzie educare Ltd. <br />All Rights Reserved</p>
                </div>
